...
for (i = 1; i <= 50000; i++) {
    db.employee.insert({
        ...
        "last_name": "Student" + Math.floor(Math.random() * 100)
    });
}
...
for (i = 1; i <= 100000; i++) {
    db.call.insert({
        "id": "a" + i,
        "employee_id": "e" + Math.floor(Math.random() * 50000),
        "customer_id": "c" + Math.floor(Math.random() * 100000),
...
for (i = 1; i <= 100000; i++) {
    db.customer.insert({
        "id": "c" + i,
        "name": "Germany",
        "city_id": "c" + Math.floor(Math.random() * 1000)
    });
};
...
for (i = 1; i <= 1000; i++) {
    db.city.insert({
        "id": "c" + i,
        "name": "City" + i,
        "country_id": "co" + Math.floor(Math.random() * 500)
    });
};
